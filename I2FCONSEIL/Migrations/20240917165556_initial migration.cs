        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Financiers_AspNetUsers_Id_User",
                        column: x => x.Id_User,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fiscaux", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Fiscaux_AspNetUsers_Id_User",
                        column: x => x.Id_User,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Sociaux", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Sociaux_AspNetUsers_Id_User",
                        column: x => x.Id_User,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Financiers_Id_User",
                table: "Financiers",
                column: "Id_User");

            migrationBuilder.CreateIndex(
                name: "IX_Fiscaux_Id_User",
                table: "Fiscaux",
                column: "Id_User");

            migrationBuilder.CreateIndex(
                name: "IX_Sociaux_Id_User",
                table: "Sociaux",
                column: "Id_User");
        }
